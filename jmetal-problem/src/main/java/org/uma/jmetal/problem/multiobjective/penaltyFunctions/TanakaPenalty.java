...
public class TanakaPenalty extends AbstractDoubleProblem implements ConstrainedProblem<DoubleSolution> {
     ...
     */
    public TanakaPenalty() {
        setNumberOfVariables(2);
        setNumberOfObjectives(2);
        setNumberOfConstraints(2);
        setName("TanakaPenalty") ;
        alpha = 2.0;
        lamda = 0.1;
    ...
    public void evaluate(DoubleSolution solution)  {
        ...
        solution.setObjective(0, solution.getVariableValue(0) + lamda*penalty);
        solution.setObjective(1, solution.getVariableValue(1) + lamda*penalty);
    }
