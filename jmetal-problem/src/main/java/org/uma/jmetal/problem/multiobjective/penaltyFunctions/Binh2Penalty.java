 ...
 */
public class Binh2Penalty extends AbstractDoubleProblem implements ConstrainedProblem<DoubleSolution> {
    ...
    public void evaluate(DoubleSolution solution) {
        ...
        fx[0] = 4.0 * x[0] * x[0] + 4 * x[1] * x[1] + lamda*penalty;
        fx[1] = (x[0] - 5.0) * (x[0] - 5.0) + (x[1] - 5.0) * (x[1] - 5.0) + lamda*penalty;
