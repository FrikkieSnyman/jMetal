 ...
 */
public class ConstrExPenalty extends AbstractDoubleProblem implements ConstrainedProblem<DoubleSolution> {
    ...
    /** Constructor */
    public ConstrExPenalty()  {
        setNumberOfVariables(2);
        setNumberOfObjectives(2);
        setNumberOfConstraints(2);
        setName("ConstrExPenalty");
        alpha = 2.0;
        lamda = 0.1;
    ...
    public void evaluate(DoubleSolution solution)  {
        ...
        f[0] = solution.getVariableValue(0) +lamda*penalty;
        f[1] = (1.0 + solution.getVariableValue(1))/solution.getVariableValue(0)  +lamda*penalty;
