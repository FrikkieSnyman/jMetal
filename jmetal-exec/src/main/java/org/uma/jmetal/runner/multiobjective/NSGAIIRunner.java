...
public class NSGAIIRunner extends AbstractAlgorithmRunner {
  ...
  public static void main(String[] args) throws JMetalException, FileNotFoundException {
    ...
    if (args.length == 1) {
      ...
      referenceParetoFront = "jmetal-problem/src/test/resources/pareto_fronts/ConstrEx.pf" ;
    }
...
//        .build() ;
    algorithm = new CABuilder<>((DoubleProblem) problem, 2500, 100).build();
    ...
    algorithm = new CABuilder((DoubleProblem)problem, 25000, 100).build();
